document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateJson() {
        ...
        // Run validators
        currentValidationResult = runAllValidators(jsonData);
        displayResults(currentValidationResult);
        
        // Show download button if there are failures
        if (currentValidationResult.summary.fail > 0) {
